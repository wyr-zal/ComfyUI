(function () {
  ...
  const CONFIG_TEMPLATES = {
    ...
    aliyun_dashscope_image: {
      label: "阿里云百炼 - Qwen Image",
      build: () => templateConfig("aliyun_dashscope_image", {
        base_url: "https://dashscope.aliyuncs.com",
        submit_path: "/api/v1/services/aigc/multimodal-generation/generation",
        auth_header: "Authorization",
        auth_prefix: "Bearer",
        poll_enabled: false,
        test_path: "/api/v1/tasks/?page_size=1",
        request_template: {},
        image_field: "",
        images_field: "",
    ...
    aliyun_dashscope_video: {
      label: "阿里云百炼 - Wan / HappyHorse 视频",
      build: () => templateConfig("aliyun_dashscope_video", {
        base_url: "https://dashscope.aliyuncs.com",
        submit_path: "/api/v1/services/aigc/video-generation/video-synthesis",
        auth_header: "Authorization",
        auth_prefix: "Bearer",
        poll_enabled: true,
        poll_path_template: "/api/v1/tasks/{task_id}",
        ...
        response_video_url_path: "output.video_url",
        response_result_url_path: "",
        response_task_id_path: "output.task_id",
        response_status_path: "output.task_status",
